...
| `PORT_XHTTP_H3` | `4443`（Dockerfile ENV 固定值） | XHTTP/3 UDP 端口（M4 永久启用） |
...
| `ENABLE_XICMP` / `ENABLE_XDNS` / `ENABLE_ECH` / `ENABLE_REVERSE` | `false` | M3 / M4 feature flag；开启条件与效果详见 [新特性使用指南](./07-new-features-guide.md) |
