...
#   part1_common = hysteria2 / tuic / anytls / vmess / vless-vision
#   part2_common = xhttp-reality_compat / up_cdn_compat / mix_compat
# v2rayn        = part1 + part2
# common        = part1_common + part2_common
#
# Note: tuic + anytls are included in the common track — mihomo / OpenClash /
# Karing all support both. Trade-off: low-version Xray-core clients sharing
# this track cannot parse tuic/anytls and will skip those two nodes (the
# remaining 6 protocols stay Xray-core-safe).
